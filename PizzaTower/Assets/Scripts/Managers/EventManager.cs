...
namespace PizzaTower.Managers
{
    public class EventManager : EventManagerAbstract
    {
        ...
        public static event Action<string> AddCoin, RemoveCoin, UpdateActivationOfUpgradeButtons;
        ...
        public void TriggerDeliveryManArrivedToParkSupervisor(IPizzaHolder i, int capacity)
            => DeliveryManArrivedToParkSupervisor?.Invoke(i, capacity);

        public void TriggerAddPizzaToDeliveryMan(IPizzaHolder i, int pizzaCountToAdd)
            => AddPizzaToDeliveryMan?.Invoke(i, pizzaCountToAdd);
        ...
        public void TriggerUpdateActivationOfUpgradeButtons(string coinsInPossession)
            => UpdateActivationOfUpgradeButtons?.Invoke(coinsInPossession);
    }
}